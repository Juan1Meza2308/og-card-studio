...
- **Convención:** Usa Conventional Commits en primera persona o imperativo, pero mantén un tono humano y orgánico. 
  - *Correcto:* `feat: integro validación de RLS en el perfil`, `fix: resuelvo parpadeo en el navbar`
  - *Incorrecto:* `fix: The AI has updated the navbar...`
...
- **Prevención de Layout Shifts (CLS):** Renderiza *skeletons* del tamaño exacto del contenido final mientras carga. No permitas que el texto o los botones "salten" al resolver promesas.
