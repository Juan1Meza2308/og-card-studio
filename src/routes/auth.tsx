...
function AuthPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    if (mode === "signup") {
      ...
      setMessage(
        error?.message ??
          (data.session ? "Account created." : "Check your email to confirm your account."),
      );
  ...
  return (
    <main className="auth-shell">
      <Link
        to="/"
        className="absolute left-5 top-5 inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground"
      >
      ...
      <div className="auth-panel">
        <Logo />
        <div className="mt-8">
          <p className="font-mono text-[10px] uppercase text-primary">Developer access</p>
