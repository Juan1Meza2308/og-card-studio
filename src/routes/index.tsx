        ...
        <section className="hero-surface">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-5 pb-20 pt-36 sm:pt-44">
            <div className="mx-auto max-w-4xl text-center">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-border/80 bg-card/70 px-3 py-1.5 font-mono text-[10px] uppercase text-muted-foreground">
                <span className="size-1.5 rounded-full bg-success" /> API v1 is live
              </div>
