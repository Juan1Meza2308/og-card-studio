    ...
    <div className="min-h-screen overflow-hidden">
      ...
      <main id="main-content" tabIndex={-1}>
        <section className="hero-surface">
          <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-10 px-8 pb-24 pt-28 sm:gap-14 sm:pt-40 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
            <motion.div
            ...
            >
              ...
              >
                <span className="size-1.5 rounded-full bg-success" /> API v1 · early access
              </motion.div>
              <motion.h1
                variants={staggerItem}
          ...
          <motion.div
            ...
            className="relative z-10 mx-auto mt-14 max-w-7xl border-t border-border/60 px-8 pt-6 sm:mt-20 sm:pt-8"
          >
